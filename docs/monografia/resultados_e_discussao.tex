...
\section{Análise dos dados de usuários}
  ...
  \begin{figure}
      \begin{center}
	\includegraphics[width=0.7\linewidth]{arquivos/escola.jpg}
      \end{center}
  ...
  \begin{figure}
	...
	\includegraphics[width=0.7\linewidth]{arquivos/trabalho_online.png}
      \end{center}
      \caption{Participantes que acham que é possível que um grupo trabalhe num mesmo projeto sem estar na mesma cidade, pela Internet}
  ...
  \begin{figure}
	...
	\includegraphics[width=0.7\linewidth]{arquivos/feira_virtual.png}
      \end{center}
      \caption{Participantes que acham que a idéia de uma feira de ciências virtual na internet é interessante}
      \label{feira_virtual}
  \end{figure}
