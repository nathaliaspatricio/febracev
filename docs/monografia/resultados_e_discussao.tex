...
\section{Relato do processo de desenvolvimento}
  ...
  \subsection{Programação pareada}
    ...
    Nesse projeto, o primeiro motivo foi rapidamente sanado, pois a resistência ao pareamento é enfraquecida nas primeiras sessões, devido aos benefícios trazidos pela prática, como redução dos erros inseridos no código e a maior rapidez na resolução de tarefas complexas. Já o problema dos horários não pode ser completamente contornado. Das 8 horas semanais dedicadas ao projeto, 5 foram dedicadas à programação pareada, e demais se deram por trabalho cooperativo à distância.
...
\section{Especificação e desenvolvimento}
  ...
  \subsection{Fase de exploração}
    ...
    \begin{itemize}
      \item
        Levantamento inicial das histórias do projeto;
      \item
  ...
  \subsection{Implementação da terceira iteração}
    ...
    \subsubsection{História 38 - Criação de páginas estáticas}
  ...
  \subsection{Implementação da quarta iteração}
    ...
    \subsubsection{História 35 - Listagens}
    ...
    \subsubsection{História 37 - Criação de \textit{templates}}
    ...
    \subsubsection{Cartões sem fazer, prometidos}
      \begin{itemize}
        %médios
        \item{1 - Convite a ex-participantes}
        \item{11 - Conteúdos adicionais de projetos}
        \item{17 - Mensagens}
        \item{18 - Notificação de conteúdo dinâmico}
        \item{29 - Solicitação de novo projeto}
        %difíceik
        \item{12 - Diário de bordo}
        \item{15 - Fórum}
        \item{21 - Estatísticas}
        \item{23 - Moderação de conteúdos}
        \item{26 - Estatísticas de uso do sistema}
      \end{itemize}

    \subsubsection{Cartões sem fazer, novos}
      \begin{itemize}
        \item{31 - Alteração de senha}
        \item{33 - Permissões de visualização}
      \end{itemize}
