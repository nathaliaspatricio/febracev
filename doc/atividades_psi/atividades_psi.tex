...
\chapter{Atividades realizadas}
  ...
  \section{Primeira iteração}
    ...
    \subsection{História 3 - Cadastro de usuário}
      A segunda parte do módulo de Login é o cadastro de usuários.

    \subsection{História 4 - Edição de perfil}
      Usuários logados no sistema podem visualizar e alterar as informações presentes em seu perfil.

    \subsection{História 5 - Visualização de perfil}
      Os perfis dos usuários podem ser visualizados por qualquer visitante do site.
